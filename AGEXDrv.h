...
#include <linux/init.h>		// fÃ¼r module_init(),
#include <linux/module.h>	// fÃ¼r MODULE_LICENSE
#include <linux/version.h>	// fÃ¼r die Version

#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,32)
	#include <linux/printk.h>	// fÃ¼r printk
#endif
...
#if LINUX_VERSION_CODE == KERNEL_VERSION(2,6,32)
	#include <linux/uaccess.h>	// fÃ¼r copy_to_user
